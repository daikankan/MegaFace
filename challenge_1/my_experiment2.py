...
MODEL = os.path.join('..', 'model', 'jb_identity.bin')
IDENTIFICATION_EXE = os.path.join('..', 'bin', 'Identification')
FUSE_RESULTS_EXE = os.path.join('..', 'bin', 'FuseResults')
MEGAFACE_LIST_BASENAME = os.path.join('.','out_root','otherFiles', 'megaface_features_CNN')
        ...
        for size in sizes:
            ...
            with open(cur_list_name) as fp:
                ...
                for i in range(len(path_list)):
                    path_list[i] = os.path.join(path_list[i])
