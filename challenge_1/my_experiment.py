...
PROBE_LIST_BASENAME = os.path.join('..','templatelists','facescrub_uncropped_features_list.json')
            ...
            with open(cur_list_name) as fp:
                ...
                for i in range(len(path_list)):
                    ...
                    if(not os.path.isfile(path_list[i])):
                        ...
                        path_list_exists.append(path_list[i])
                    if (i % 10000 == 0 and i > 0):
                        print str(i) + " / " + str(len(path_list))
                featureFile["path"] = path_list_exists
